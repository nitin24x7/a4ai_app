    ...
    >
      ...
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 lg:px-8 pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-24 bg-transparent">
        ...
        <div className="text-center relative z-10">
          <h1 className="font-bold tracking-[-0.02em]" style={{ lineHeight: 1 }}>
            <span
              className="block lg:whitespace-nowrap text-neutral-900"
            ...
            >
              <Link to="/dashboard/test-generator" className="w-full block">
                ...
                >
                  <span
                    aria-hidden
                    className="pointer-events-none absolute inset-x-0 top-0 h-1/2 rounded-t-[14px] bg-gradient-to-b from-white/15 to-transparent"
                  />
